return function(settings)
    ...
    hl.bind(mod .. " + F1", exec("bash ~/.config/hypr/scripts/keybinds-help.sh"))
    hl.bind(mod .. " + X", exec("bash ~/.config/hypr/scripts/clipboard-menu.sh"))
    hl.bind(mod .. " + ALT + P", exec("bash ~/.config/hypr/scripts/theme-selector.sh"))
    hl.bind(mod .. " + ALT + W", exec("bash ~/.config/hypr/scripts/special-workspaces-menu.sh"))
