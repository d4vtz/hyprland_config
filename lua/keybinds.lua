return function(settings)
    ...
    hl.bind(mod .. " + SPACE", exec("~/.config/hypr/scripts/desktop-search.sh"))
    ...
    hl.bind(mod .. " + C", exec("qs ipc call system clipboard"))
    ...
    hl.bind("PRINT", exec("~/.config/hypr/scripts/screenshot.sh area edit"), { locked = true })
    hl.bind("SHIFT + PRINT", exec("~/.config/hypr/scripts/screenshot.sh output copy"), { locked = true })
    hl.bind("CTRL + PRINT", exec("~/.config/hypr/scripts/screenshot.sh active edit"), { locked = true })

    hl.bind("XF86AudioRaiseVolume", exec("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+ && qs ipc call osd volume"), { locked = true, repeating = true })
    hl.bind("XF86AudioLowerVolume", exec("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%- && qs ipc call osd volume"), { locked = true, repeating = true })
    hl.bind("XF86AudioMute", exec("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle && qs ipc call osd volume"), { locked = true })
    hl.bind("XF86AudioMicMute", exec("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle && qs ipc call osd microphone"), { locked = true })
    hl.bind("XF86MonBrightnessUp", exec("brightnessctl -e4 -n2 set 5%+ && qs ipc call osd brightness"), { locked = true, repeating = true })
    hl.bind("XF86MonBrightnessDown", exec("brightnessctl -e4 -n2 set 5%- && qs ipc call osd brightness"), { locked = true, repeating = true })
