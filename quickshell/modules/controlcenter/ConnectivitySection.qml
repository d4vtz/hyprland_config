...
GridLayout {
    ...
    ToggleTile { Layout.fillWidth: true; iconName: SystemStatus.bluetoothEnabled ? "bluetooth-active" : "bluetooth-disabled"; iconCategory: "status"; icon: "󰂯"; title: "Bluetooth"; subtitle: SystemStatus.bluetoothEnabled ? (SystemStatus.bluetoothAudioActive ? "Audio conectado" : "Activado") : "Desactivado"; checked: SystemStatus.bluetoothEnabled; interactive: !controller.busy; actionIconName: "preferences-system-bluetooth"; actionIconCategory: "apps"; actionIcon: "󰍹"; accent: Theme.purple; onClicked: controller.runCommand(["bluetoothctl", "power", SystemStatus.bluetoothEnabled ? "off" : "on"], "Cambiando Bluetooth…"); onActionClicked: controller.launchExternal(["blueman-manager"]) }
